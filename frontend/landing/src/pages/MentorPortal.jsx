  ...
  return (
    <PageLayout>
      ...
      <div className="mt-10 glass-card p-8 text-center">
        ...
        <a href="http://localhost:5175" className="inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-bold no-underline transition-all hover:scale-105"
